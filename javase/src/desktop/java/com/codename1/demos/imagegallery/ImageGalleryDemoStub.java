 ...
 * @author Shai Almog
 */
public class ImageGalleryDemoStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "ImageGalleryDemo";
    ...
    private ImageGalleryDemo mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ImageGalleryDemoStub());
    }
